...
from jane_web.client_tool_json import find_json_object_end as web_find_json_object_end


def test_web_client_tool_json_reexports_shared_scanner():
    assert web_find_json_object_end is find_json_object_end
