...
CASES: list[dict] = [
    ...
    {"prompt": "actually what's the weather in tokyo right now",
     ...
     "expected_stage": "stage2",
     "expected_class_contains": "weather",
     "note": "pivot from todo to weather"},
    ...
    {"prompt": "ok thanks",
     ...
     "expected_stage": "stage3",
     "note": "acknowledgment with no open question — nothing to do"},
    {"prompt": "actually forget it",
     ...
     "expected_stage": "stage3",
     "note": "abandon — should abandon pending + escalate (or classify as end_conversation)",
     "expected_class_contains_any": ["end", "others"]},
