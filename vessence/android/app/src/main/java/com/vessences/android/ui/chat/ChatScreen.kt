...
fun ChatScreen(
    ...
    AttachmentSheet(
        ...
        interruptibleVoiceEnabled = state.interruptibleVoiceMode,
        onInterruptibleVoiceChange = { viewModel.setInterruptibleVoiceMode(it) },
    ...
    Column(
        ...
        ChatInputRow(
            ...
            onCancel = { viewModel.cancelCurrentResponse() },
            onVoiceCaptureStart = { viewModel.prepareForInterruptibleVoiceCapture() },
