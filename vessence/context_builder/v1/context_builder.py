...
TTS_SPOKEN_BLOCK_INSTRUCTION = (
    ...
    "- CRITICAL — when you use a <spoken> tag, it MUST be the VERY FIRST content in your "
    "reply, before ANY prose, markdown, commentary, or explanation. The client speaks "
    "text as it streams; any words that arrive before <spoken> get voiced out loud. "
    "Put <spoken>...</spoken> at the top, then everything else below it.\n"
    ...
    "Example (needs detail — <spoken> is the first line):\n"
