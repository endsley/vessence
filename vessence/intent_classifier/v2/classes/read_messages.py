...
EXAMPLES = [
    ...
    "what did my wife text me", "did kathia text me",
    "read texts from mom", "any messages from john",
    "check texts from my wife", "what did bob text me",
    "read my unread messages", "show my texts",
    "what texts do I have", "any new texts from anyone",
    "read the message from sarah", "what did she text",
    "check if anyone texted me", "any texts while I was driving",
    "read my text messages", "pull up my texts",
    "what text messages came in", "any texts from dad",
    "show messages from kathia", "check my SMS",
    "read SMS from john", "any unread texts",
    "what did john say in his text", "read the last text message",
    "check texts from work", "any text messages from my boss",
    ...
    "check messages from my sister", "any texts from mom",
    "read all my text messages", "did kathia message me",
    "show new texts", "did anyone text me",
    "what text messages do I have", "check text messages",
    "read recent texts", "show me my texts",
    "any new texts from my wife", "check if john texted me",
