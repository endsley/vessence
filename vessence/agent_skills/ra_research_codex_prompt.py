...
def codex_model_policy(smart_model_label: str, smart_provider: str) -> str:
    return (
...
def codex_synthesis_instructions() -> list[str]:
    return [
...
def codex_required_output_contract() -> dict[str, Any]:
    return {
...
def codex_synthesis_payload(
    *,
    ...
    return {
        ...
        "safety_boundary": codex_safety_boundary(),
