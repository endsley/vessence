...
-   **Skill: Rheumatoid Arthritis Remission Research Loop**
    ...
    -   **Reports:** Sends the initial email report after 4 runs, then every 72 hours, from `julioprocess@gmail.com` to Chieh when Gmail OAuth for that sender is available.
