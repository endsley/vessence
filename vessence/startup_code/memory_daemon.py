...
async def load_models():
    ...
    from agent_skills.memory_retrieval import _embed_query_text, build_memory_sections  # noqa: F401
    import agent_skills.search_memory as search_memory  # noqa: F401
...
async def query_memory(q: str, essence_path: str = ""):
    ...
    from agent_skills.memory_retrieval import _embed_query_text, build_memory_sections
